...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "text-palette-darkest",
    secondary: "bg-palette-lightest",
    danger: "text-red-600 hover:text-red-700 hover:bg-red-50",
    ghost: "shadow-none border-transparent bg-transparent hover:bg-palette-mediumLight/20 active:bg-palette-mediumLight/40"
  };
