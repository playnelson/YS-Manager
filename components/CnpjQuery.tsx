  ...
  return (
    <div className="h-full flex flex-col gap-4 bg-win95-bg p-4 win95-raised">
      ...
      <div className="flex gap-4 items-start">
        ...
        <div className="w-1/2 win95-sunken bg-white p-4 text-xs font-mono space-y-2 h-[300px] overflow-y-auto">
           <h4 className="font-bold border-b border-gray-300 mb-2">LOG DE PROCESSAMENTO</h4>
...
const VehicleModule: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-4 bg-win95-bg p-4 win95-raised">
      <div className="bg-[#000080] text-white px-2 py-1 text-sm font-bold flex justify-between items-center gap-2">
      ...
      {mode === 'plate' && (
        <div className="flex gap-4">
           ...
           <div className="w-1/2">
              {plateData ? (
                <div className="win95-raised bg-white p-4 h-full">
                   <h3 className="text-sm font-black uppercase border-b-2 border-black mb-4">Informações da Placa</h3>
                   <div className="space-y-4">
                      ...
                      <div className="flex justify-between border-b border-gray-200 pb-1">
                         <span className="text-xs font-bold text-gray-500">ORIGEM (ESTIMADA):</span>
                         <span className="text-xs font-bold text-blue-800">{plateData.state}</span>
                      </div>
