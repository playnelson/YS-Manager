...
export const ProfessionalLinks: React.FC<ProfessionalLinksProps> = ({ links, onChange }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-[#808080]/10">
      {/* Top Bar */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
                {filteredLinks.map(link => (
                    <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="group flex flex-col items-center p-3 rounded hover:bg-[#000080]/10 hover:shadow-inner border border-transparent hover:border-[#000080]/20 transition-all relative"
                        title={link.url}
                    >
                        ...
                        <div className="text-center w-full">
                            <div className="text-xs font-bold text-black truncate leading-tight group-hover:text-[#000080] group-hover:underline">
                                {link.title}
                            </div>
          ...
          <div className="bg-win95-bg w-full max-w-sm win95-raised p-1 shadow-2xl animate-in zoom-in duration-200">
            ...
            <form onSubmit={handleSave} className="p-4 space-y-4">
              ...
              <div className="flex gap-2 pt-2 border-t border-gray-300">
                ...
                <Button type="submit" className="flex-1 bg-win95-blue text-white">SALVAR</Button>
              </div>
            </form>
          </div>
        </div>
