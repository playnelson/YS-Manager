  ...
  return (
    <div className="h-full flex gap-2">
      ...
      <div className="w-80 flex flex-col bg-win95-bg win95-raised p-1 shrink-0">
        <div className="bg-win95-blue text-white px-2 py-1 text-xs font-bold uppercase flex justify-between items-center mb-2 shadow-sm">
          ...
          {filteredHandoffs.length === 0 ? (
            ...
            filteredHandoffs.map(h => (
              <div 
                ...
                className={`p-2 border border-transparent cursor-pointer hover:bg-gray-100 transition-colors ${selectedId === h.id ? 'bg-blue-50 border-blue-200' : ''}`}
              >
        ...
        {isCreating ? (
          <div className="flex flex-col h-full animate-in fade-in zoom-in duration-200">
             <div className="flex items-center gap-2 mb-4 pb-2 border-b border-white">
                <ClipboardList size={20} className="text-win95-blue" />
                <h2 className="text-sm font-black uppercase text-black">Novo Registro de Passagem</h2>
             </div>
